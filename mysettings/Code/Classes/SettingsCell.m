...
@synthesize configuration, changedsettings, stringsTable, value, titlelabel, valueview;
...
- (id)initWithTitlelabel:(BOOL)hastitlelabel reuseIdentifier:(NSString *)reuseIdentifier {
	if ((self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier])) {
		if(hastitlelabel) {
            ...
            titlelabel.backgroundColor = [UIColor clearColor]; // PA: iOS 5 uses off white color for cell background so label can't be white
...
- (id)initWithValuelabelAndReuseIdentifier:(NSString *)reuseIdentifier {
	if ((self = [self initWithTitlelabel:YES reuseIdentifier:reuseIdentifier])) {
        ...
        valuelabel.backgroundColor = [UIColor clearColor];     // PA: iOS 5 uses off white color for cell background so label can't be white
